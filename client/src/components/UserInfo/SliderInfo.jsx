                ...
                <ul className="mt-5 grid bg-gray-50">
                    <li>
                        <div className="relative">
                            <input className="peer hidden" id="radio_1" type="radio" name="radio" onClick={handleAccountInformation}/>
                            <span
                    ...
                    <li>
                        <div className="relative">
                            <input className="peer hidden" id="radio_2" type="radio" name="radio" onClick={handleHistoryOrders}/>
                            <span
                                className="peer-checked:border-[#D52C2C] peer-checked:border-8 absolute top-1/2 box-content block h-[65%] -translate-y-1/2 bg-white"></span>
                            <label
                                className="peer-checked:border-2 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                    ...
                    <li>
                        <div className="relative">
                            <input className="peer hidden" id="radio_3" type="radio" name="radio" onClick={handleAddressDelivery}/>
                            <span
                                className="peer-checked:border-[#D52C2C] peer-checked:border-8 absolute top-1/2 box-content block h-[65%] -translate-y-1/2 bg-white"></span>
                            <label
                                className="peer-checked:border-2 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
