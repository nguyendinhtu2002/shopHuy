                        ...
                        <>
                            <div className="relative mt-3 space-y-3 border-2 border-black px-3 py-3 h-[140px]">
                                ...
                                <div className="absolute flex text-[14px] gap-5 right-3 top-1/2 -translate-y-1/2">
                                    <a className="cursor-pointer text-[#0500FF] hover:text-[#dc3545] transition duration-300"
                                       type="button" onClick={handleEdit}>Cập nhật</a>
                                    <a className="cursor-pointer text-[#0500FF] hover:text-[#dc3545] transition duration-300"
                                       type="button">Xóa</a>
                                </div>
                            </div>
                ...
                {isEdit &&
                    <>
                        <div className="fixed top-0 left-0 z-10 w-screen h-screen bg-neutral-700/20">
                            <div
                                className="w-[50%] px-10 py-4 relative top-[15%] translate-x-[60%] left-0 bg-[#EEEEEE]">
                                <div className="space-y-8">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <input className="p-4 text-2xl w-[280px]" type="text"
                                               placeholder="Số điện thoại"/>
                                    </div>
                                    <div className="">
                                        <input className="p-4 text-2xl w-full" type="text"
                                ...
                                <div className="mt-4 space-x-1 flex justify-end text-sm">
                                    ...
                                    <div className="border border-1 border-[#F94E30] ">
                                        <button
                                            className="bg-[#F94E30] w-[120px] text-white text-2xl py-2 hover:bg-[#FF8773] transition duration-300">Hoàn
                                            thành
                                        </button>
                                    </div>
                                </div>
