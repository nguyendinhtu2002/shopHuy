            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div className="px-4 pt-8">
                    ...
                    <form className="mt-5 grid gap-6">
                        <div className="relative">
                            <input className="peer hidden" id="radio_1" type="radio" name="radio" onClick={handlePaymentByCard}/>
                            <span
                            ...
                            <label
                                ...
                                <div className="ml-5">
                                    <span className="mt-2 font-semibold">Payment By Card</span>
                                    <p className="text-slate-500  leading-6">Delivery: 2-4 Days</p>
                                </div>
                            </label>
                        </div>
                        <div className="relative">
                            ...
                            <label
                                ...
                                <div className="ml-5">
                                    <span className="mt-2 font-semibold">Internet Banking</span>
                                    <p className="text-slate-500  leading-6">Delivery: 2-4 Days</p>
                                </div>
                            </label>
                        </div>
                        <div className="relative">
                            ...
                            <label
                                ...
                                <img className="w-14 object-contain" src="/images/naorrAeygcJzX0SyNI4Y0.png" alt=""/>
                                <div className="ml-5">
                                    <span className="mt-2 font-semibold">Ship COD</span>
                                    <p className="text-slate-500  leading-6">Delivery: 2-4 Days</p>
                                </div>
                            </label>
                        </div>
