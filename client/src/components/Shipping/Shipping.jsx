    ...
    return (
        <div className="mx-auto mb-5">
                ...
                <div className="mt-4 py-2  sm:mt-0 sm:ml-auto sm:text-base">
                    <div className="relative">
                        <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                            ...
                            <li className="flex items-center space-x-3 text-left sm:space-x-4">
                                <Link
                                    className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-400  font-semibold text-white"
                                    href="#"
                                >
                                    3
                                </Link>
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    <p className="text-gray-400">
                        Hoàn thành giao hàng bằng cách điền vào các thông tin dưới đây.
                    </p>
                    <div className="">
                        <label htmlFor="numberPhone" className="mt-4 mb-2 block font-medium">
                        ...
                        <div className="mt-6 border-t border-b py-2">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <p className="font-semibold text-gray-900">{formatPrice(total * 0.1)}</p>
                            </div>
                        </div>
                        <div className="mt-6 flex items-center justify-between">
