        ...
        return (
            <>
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        <label htmlFor="email" className="mt-4 mb-2 block  font-medium">Email</label>
                        ...
                        <label htmlFor="card-holder" className="mt-4 mb-2 block  font-medium">Card Holder</label>
                        <div className="relative">
                        ...
                        <label htmlFor="card-no" className="mt-4 mb-2 block  font-medium">Card Details</label>
                        <div className="flex">
                        ...
                        <label htmlFor="billing-address" className="mt-4 mb-2 block  font-medium">Billing
                            Address</label>
        ...
        <div className="mx-auto mb-5">
                ...
                <div className="mt-4 py-2  sm:mt-0 sm:ml-auto sm:text-base">
                    <div className="relative">
                        <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                            ...
                            <li className="flex items-center space-x-3 text-left sm:space-x-4">
                                <Link className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-600  font-semibold text-white ring ring-gray-600 ring-offset-2"
                                   to="#">2</Link>
                            ...
                            <li className="flex items-center space-x-3 text-left sm:space-x-4">
                                <Link className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-400  font-semibold text-white"
                                   href="#">3</Link>
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <p className="text-gray-400">Complete the delivery details by filling in the information below.</p>
                    <div className="">
                        <label htmlFor="email" className="mt-4 mb-2 block  font-medium">Email</label>
                        <div className="relative">
                            <input type="text" id="email" name="email"
                    ...
                    <Link to="/payment">
                        <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Payment
                        </button>
                    </Link>
