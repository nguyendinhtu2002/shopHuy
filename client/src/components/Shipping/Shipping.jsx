            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div className="px-4 pt-8">
                    ...
                    {item.description}
                                    ...
                                    <p className="font-bold">{formatPrice(item.price)}<span
                                        className="text-[#FA7862]"><span
                                        className="font-medium mx-1">x</span>{item.quantity}</span></p>
                                </div>
                            </div>
                        ))}
                    </div>
                                        ...
                                        <div className="grid grid-cols-3">
                                            <div className="col-span-1 border-r-2 border-black pr-4">
                                                <img className=""
                                                     ...
                                                     alt="Momo"/>
                                                <p className="uppercase text-center text-3xl font-semibold">Techmedia</p>
                                            </div>
                                            <div className="col-span-2 ml-4">
                                                <p><span>Tên chủ tài khoản: </span> <span
                                                    className="uppercase">Techmedia</span></p>
                                                <p><span>STK: </span> <span className="uppercase">0123456789</span></p>
                                                <p><span>Lưu ý</span> <span className="text-[#FF0000]">*</span></p>
                                                <p className="font-semibold">Khách hàng kiểm tra kĩ thông tin trước khi
                                                    chuyển khoản</p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer mt-3">
                        <input type="checkbox" value="" className="sr-only peer text-2xl" onClick={handleDefaultAddress}/>
                        <div
                            ...
                            after:h-7 after:w-7 after:transition-all peer-checked:bg-blue-600"></div>
                        <span className="ml-3 text-2xl text-gray-900">Sử dụng địa chỉ mặc định</span>
                    </label>
                    ...
                    <Link >
                        <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white hover:opacity-80 transition duration-300">
                            Thanh toán
                        </button>
                    </Link>
                </div>
