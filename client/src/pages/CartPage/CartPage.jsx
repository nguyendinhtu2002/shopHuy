            ...
            <div className="cart bg-whitesmoke">
                <div className="container">
                                    ...
                                    <div className="cart-ctr py-4" key={cart?.id}>
                                        ...
                                        <div className="cart-ctd flex items-center space-x-3">
                                            <div className="w-[120px]">
                                                <img className="img-cover rounded-lg"
                                                     src="https://i.dummyjson.com/data/products/1/1.jpg" alt="iPhone 9"/>
                                            </div>
                  ...
                  {formatPrice(totalAmount)}
                                ...
                                <div>
                                    <Link to="/shipping"
                                          className="text-center text-white rounded-lg block p-3 bg-[#3A37D5] hover:bg-[#3A37D5]/80 transition duration-300">Checkout</Link>
                                </div>
                    ...
                    <div className="cart-mobile cart-ctable-mobile">
                        <div className="cart-cbody bg-white">
                            {carts.map((cart, idx) => {
                                return (
                                    <div className=" py-4 flex justify-between items-center space-x-3" key={cart?.id}>
                                        <div className="cart-ctd ">
                                            <div className="w-[120px]">
                                                <img className="img-cover rounded-lg"
                                                     src="https://i.dummyjson.com/data/products/1/1.jpg" alt="iPhone 9"/>
                                        ...
                                        <div className="cart-ctxt space-y-3">
                                            ...
                                            <div className="flex space-x-3">
                                                <p className="cart-ctxt line-through">{formatPrice(cart?.price)}</p>
                                                <p className="cart-ctxt text-orange fw-5">{formatPrice(cart?.discountedPrice)}</p>
                                            </div>
